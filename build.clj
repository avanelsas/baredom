...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :scm       {:url                "https://github.com/avanelsas/baredom"
                            ...
                            :tag                (str "v" version)}
                :pom-data  [[:description "80 native Web Components with centralised theming — stateless, framework-free, zero runtime. Built with ClojureScript, compiled to tree-shakeable ESM."]
