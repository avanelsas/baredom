...
(def lib       'com.github.avanelsas/barebuild)
(def version   "0.1.0")
...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :scm       {:url                "https://github.com/avanelsas/baredom"
                            ...
                            :tag                (str "barebuild-v" version)}
                :pom-data  [[:description "Server-resource runtime for BareDOM — drives presentational web components from server state without client-side business logic. Reads and writes."]
                            [:url "https://github.com/avanelsas/baredom/tree/main/barebuild"]
                            [:licenses
                             [:license
                              [:name "MIT License"]
