...
var root_23377 = el.attachShadow(({"mode": "open"}));
var style_23378 = document.createElement("style");
var item_div_23379 = document.createElement("div");
var label_col_23380 = document.createElement("div");
var label_slot_23381 = document.createElement("slot");
var label_text_23382 = document.createElement("span");
var track_col_23383 = document.createElement("div");
var marker_23384 = document.createElement("div");
var icon_slot_23385 = document.createElement("slot");
var default_icon_23386 = document.createElement("span");
var connector_23387 = document.createElement("div");
var content_col_23388 = document.createElement("div");
var title_el_23389 = document.createElement("div");
var body_el_23390 = document.createElement("div");
var default_slot_23391 = document.createElement("slot");
var actions_el_23392 = document.createElement("div");
var actions_slot_23393 = document.createElement("slot");
(style_23378.textContent = app.components.x_timeline_item.x_timeline_item.style_text);

item_div_23379.setAttribute("class","timeline-item");

label_col_23380.setAttribute("class","label-col");

label_slot_23381.setAttribute("name","label");

label_text_23382.setAttribute("class","label-text");

label_slot_23381.appendChild(label_text_23382);

label_col_23380.appendChild(label_slot_23381);

track_col_23383.setAttribute("class","track-col");

marker_23384.setAttribute("class","marker");

icon_slot_23385.setAttribute("name","icon");

default_icon_23386.setAttribute("class","default-icon");

default_icon_23386.setAttribute("aria-hidden","true");

icon_slot_23385.appendChild(default_icon_23386);

marker_23384.appendChild(icon_slot_23385);

connector_23387.setAttribute("class","connector");

track_col_23383.appendChild(marker_23384);

track_col_23383.appendChild(connector_23387);

content_col_23388.setAttribute("class","content-col");

title_el_23389.setAttribute("class","title");

body_el_23390.setAttribute("class","body");

body_el_23390.appendChild(default_slot_23391);

actions_el_23392.setAttribute("class","actions");

actions_slot_23393.setAttribute("name","actions");

actions_el_23392.appendChild(actions_slot_23393);

content_col_23388.appendChild(title_el_23389);

content_col_23388.appendChild(body_el_23390);

content_col_23388.appendChild(actions_el_23392);

item_div_23379.appendChild(label_col_23380);

item_div_23379.appendChild(track_col_23383);

item_div_23379.appendChild(content_col_23388);

root_23377.appendChild(style_23378);

root_23377.appendChild(item_div_23379);

app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.set(el,app.components.x_timeline_item.x_timeline_item.k_refs,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"connector","connector",-1517293248),new cljs.core.Keyword(null,"label-text","label-text",-1566972381),new cljs.core.Keyword(null,"marker","marker",865118313),new cljs.core.Keyword(null,"default-icon","default-icon",491415788),new cljs.core.Keyword(null,"label-col","label-col",1883390160),new cljs.core.Keyword(null,"track-col","track-col",629248272),new cljs.core.Keyword(null,"body-el","body-el",-277974608),new cljs.core.Keyword(null,"default-slot","default-slot",-1145647151),new cljs.core.Keyword(null,"root","root",-448657453),new cljs.core.Keyword(null,"actions-slot","actions-slot",1424248629),new cljs.core.Keyword(null,"title-el","title-el",-401767816),new cljs.core.Keyword(null,"content-col","content-col",767367449),new cljs.core.Keyword(null,"item-div","item-div",1630512700),new cljs.core.Keyword(null,"actions-el","actions-el",1486248509),new cljs.core.Keyword(null,"icon-slot","icon-slot",1874301182),new cljs.core.Keyword(null,"label-slot","label-slot",-1755862561)],[connector_23387,label_text_23382,marker_23384,default_icon_23386,label_col_23380,track_col_23383,body_el_23390,default_slot_23391,root_23377,actions_slot_23393,title_el_23389,content_col_23388,item_div_23379,actions_el_23392,icon_slot_23385,label_slot_23381]));
...
app.components.x_timeline_item.x_timeline_item.apply_model_BANG_ = (function app$components$x_timeline_item$x_timeline_item$apply_model_BANG_(el,p__23369){
var map__23371 = p__23369;
var map__23371__$1 = cljs.core.__destructure_map(map__23371);
var m = map__23371__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"title","title",636505583));
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var effective_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"effective-position","effective-position",840072317));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var marker_icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"marker-icon","marker-icon",424963779));
var marker_aria = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23371__$1,new cljs.core.Keyword(null,"marker-aria","marker-aria",-353426855));
var map__23372_23398 = app.components.x_timeline_item.x_timeline_item.ensure_refs_BANG_(el);
var map__23372_23399__$1 = cljs.core.__destructure_map(map__23372_23398);
var label_text_23400 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23372_23399__$1,new cljs.core.Keyword(null,"label-text","label-text",-1566972381));
var marker_23401 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23372_23399__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
var title_el_23402 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23372_23399__$1,new cljs.core.Keyword(null,"title-el","title-el",-401767816));
var default_icon_23403 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23372_23399__$1,new cljs.core.Keyword(null,"default-icon","default-icon",491415788));
var label_text_23404__$1 = label_text_23400;
var marker_23405__$1 = marker_23401;
var title_el_23406__$1 = title_el_23402;
var default_icon_23407__$1 = default_icon_23403;
...
var host_label_23428 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(title,""))?title:((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(label,""))?label:null
));
if(cljs.core.truth_(host_label_23428)){
el.setAttribute("aria-label",host_label_23428);
} else {
el.removeAttribute("aria-label");
}

marker_23405__$1.setAttribute("aria-label",marker_aria);

(label_text_23404__$1.textContent = label);

if((!((marker_icon == null)))){
(default_icon_23407__$1.textContent = marker_icon);
} else {
(default_icon_23407__$1.textContent = "");
}

if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(title,"")){
title_el_23406__$1.removeAttribute("hidden");

(title_el_23406__$1.textContent = title);
} else {
title_el_23406__$1.setAttribute("hidden","");

(title_el_23406__$1.textContent = "");
}
...
var new_m_23437 = app.components.x_timeline_item.x_timeline_item.read_model(el);
var old_m_23438 = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(el,app.components.x_timeline_item.x_timeline_item.k_model);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(old_m_23438,new_m_23437)){
app.components.x_timeline_item.x_timeline_item.apply_model_BANG_(el,new_m_23437);
} else {
}
...
var m_23447 = (function (){var or__5142__auto__ = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(el,app.components.x_timeline_item.x_timeline_item.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
el.dispatchEvent((new CustomEvent(app.components.x_timeline_item.model.event_click,({"detail": cljs.core.clj__GT_js(app.components.x_timeline_item.model.click_detail(m_23447)), "bubbles": true, "composed": true, "cancelable": true}))));
...
var m_23452 = (function (){var or__5142__auto__ = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(el,app.components.x_timeline_item.x_timeline_item.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return app.components.x_timeline_item.x_timeline_item.read_model(el);
...
if(app.components.x_timeline_item.model.interactive_eligible_QMARK_(m_23452)){
...
var key_23454 = e.key;
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(key_23454,"Enter")) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(key_23454," ")))){
var m_23455 = (function (){var or__5142__auto__ = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(el,app.components.x_timeline_item.x_timeline_item.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return app.components.x_timeline_item.x_timeline_item.read_model(el);
...
if(app.components.x_timeline_item.model.interactive_eligible_QMARK_(m_23455)){
e.preventDefault();
...
var click_h_23456 = (function (e){
return app.components.x_timeline_item.x_timeline_item.on_click(el,e);
});
var keydown_h_23457 = (function (e){
return app.components.x_timeline_item.x_timeline_item.on_keydown(el,e);
});
el.addEventListener("click",click_h_23456);

el.addEventListener("keydown",keydown_h_23457);

app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.set(el,app.components.x_timeline_item.x_timeline_item.k_handlers,({"click": click_h_23456, "keydown": keydown_h_23457}));
...
var hs_23459 = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(el,app.components.x_timeline_item.x_timeline_item.k_handlers);
if(cljs.core.truth_(hs_23459)){
var click_h_23460 = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(hs_23459,"click");
var keydown_h_23461 = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(hs_23459,"keydown");
...
var dp_23482 = this$.getAttribute(app.components.x_timeline_item.model.data_attr_position);
if(cljs.core.truth_(dp_23482)){
app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.set(this$,app.components.x_timeline_item.x_timeline_item.k_parent_pos,dp_23482);
} else {
}
...
var m_23483 = (function (){var or__5142__auto__ = app.components.x_timeline_item.x_timeline_item.goog$module$goog$object.get(this$,app.components.x_timeline_item.x_timeline_item.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
app.components.x_timeline_item.x_timeline_item.dispatch_connected_BANG_(this$,m_23483);
