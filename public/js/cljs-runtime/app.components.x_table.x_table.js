...
var caption_div_23280 = document.createElement("div");
var slot_el_23281 = document.createElement("slot");
(style_23279.textContent = app.components.x_table.x_table.style_text);

caption_div_23280.setAttribute("part","caption");

caption_div_23280.setAttribute("hidden","");

root_23278.appendChild(style_23279);

root_23278.appendChild(caption_div_23280);

root_23278.appendChild(slot_el_23281);

app.components.x_table.x_table.goog$module$goog$object.set(el,app.components.x_table.x_table.k_refs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"root","root",-448657453),root_23278,new cljs.core.Keyword(null,"caption-div","caption-div",1485363333),caption_div_23280,new cljs.core.Keyword(null,"slot-el","slot-el",1985374132),slot_el_23281], null));
...
var rows_23290 = el.querySelectorAll("x-table-row");
var len_23291 = rows_23290.length;
var i_23292 = (0);
while(true){
if((i_23292 < len_23291)){
var row_23293 = (rows_23290[i_23292]);
if((cljs.core.mod((i_23292 + (1)),(2)) === (0))){
row_23293.setAttribute("data-stripe","even");
} else {
row_23293.removeAttribute("data-stripe");
}

var G__23294 = (i_23292 + (1));
i_23292 = G__23294;
continue;
} else {
}
...
app.components.x_table.x_table.apply_model_BANG_ = (function app$components$x_table$x_table$apply_model_BANG_(el,p__23273){
var map__23274 = p__23273;
var map__23274__$1 = cljs.core.__destructure_map(map__23274);
var m = map__23274__$1;
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var caption = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"caption","caption",-855383902));
var selectable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"selectable","selectable",370587038));
var striped_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"striped?","striped?",-797214979));
var bordered_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"bordered?","bordered?",562358476));
var full_width_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"full-width?","full-width?",1477288349));
var compact_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"compact?","compact?",1216893298));
var row_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23274__$1,new cljs.core.Keyword(null,"row-count","row-count",1060167988));
var map__23275_23295 = app.components.x_table.x_table.ensure_refs_BANG_(el);
var map__23275_23296__$1 = cljs.core.__destructure_map(map__23275_23295);
var caption_div_23297 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23275_23296__$1,new cljs.core.Keyword(null,"caption-div","caption-div",1485363333));
var caption_div_23298__$1 = caption_div_23297;
...
var ms_23299 = app.components.x_table.model.aria_multiselectable(selectable);
if(cljs.core.truth_(ms_23299)){
el.setAttribute("aria-multiselectable",ms_23299);
} else {
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(caption,"")){
(caption_div_23298__$1.textContent = caption);

caption_div_23298__$1.removeAttribute("hidden");
} else {
(caption_div_23298__$1.textContent = "");

caption_div_23298__$1.setAttribute("hidden","");
}
...
var new_m_23301 = app.components.x_table.x_table.read_model(el);
var old_m_23302 = app.components.x_table.x_table.goog$module$goog$object.get(el,app.components.x_table.x_table.k_model);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(old_m_23302,new_m_23301)){
app.components.x_table.x_table.apply_model_BANG_(el,new_m_23301);
} else {
}
...
var detail_23304 = cljs.core.clj__GT_js(app.components.x_table.model.sort_detail(col_index,direction,previous_direction));
el.dispatchEvent((new CustomEvent(app.components.x_table.model.event_sort,({"detail": detail_23304, "bubbles": true, "composed": true, "cancelable": true}))));
...
var detail_23312 = cljs.core.clj__GT_js(app.components.x_table.model.row_select_detail(row_index,selected_QMARK_,selectable));
el.dispatchEvent((new CustomEvent(app.components.x_table.model.event_row_select,({"detail": detail_23312, "bubbles": true, "composed": true, "cancelable": true}))));
...
var selected_rows_23313 = el.querySelectorAll("x-table-row[selected]");
var len_23314 = selected_rows_23313.length;
var i_23315 = (0);
while(true){
if((i_23315 < len_23314)){
(selected_rows_23313[i_23315]).removeAttribute("selected");

var G__23316 = (i_23315 + (1));
i_23315 = G__23316;
continue;
} else {
}
...
var cell_23319 = e.target;
var col_index_23320 = app.components.x_table.x_table.col_index_of(cell_23319);
var direction_23321 = app.components.x_table.x_table.goog$module$goog$object.get(e.detail,"direction");
var prev_dir_23322 = app.components.x_table.x_table.goog$module$goog$object.get(e.detail,"previousDirection");
if((col_index_23320 >= (0))){
e.stopPropagation();

app.components.x_table.x_table.dispatch_sort_BANG_(el,col_index_23320,direction_23321,prev_dir_23322);
} else {
}
...
var m_23327 = (function (){var or__5142__auto__ = app.components.x_table.x_table.goog$module$goog$object.get(el,app.components.x_table.x_table.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
...
var selectable_23328 = new cljs.core.Keyword(null,"selectable","selectable",370587038).cljs$core$IFn$_invoke$arity$1(m_23327);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(selectable_23328,"none")){
var row_23343 = e.target;
var row_index_23344 = app.components.x_table.x_table.goog$module$goog$object.get(e.detail,"rowIndex");
var currently_QMARK__23345 = row_23343.hasAttribute("selected");
var will_select_QMARK__23346 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selectable_23328,"single"))?cljs.core.not(currently_QMARK__23345):cljs.core.not(currently_QMARK__23345));
app.components.x_table.x_table.dispatch_row_select_BANG_(el,row_index_23344,will_select_QMARK__23346,selectable_23328);

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selectable_23328,"single")){
app.components.x_table.x_table.handle_single_select_BANG_(el,row_23343);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selectable_23328,"multi")){
app.components.x_table.x_table.handle_multi_select_BANG_(el,row_23343);
} else {
}
}
} else {
...
var m_23348 = (function (){var or__5142__auto__ = app.components.x_table.x_table.goog$module$goog$object.get(el,app.components.x_table.x_table.k_model);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return app.components.x_table.x_table.read_model(el);
...
if(cljs.core.truth_(new cljs.core.Keyword(null,"striped?","striped?",-797214979).cljs$core$IFn$_invoke$arity$1(m_23348))){
app.components.x_table.x_table.update_stripe_attrs_BANG_(el);
} else {
}
...
var sort_h_23349 = (function (e){
return app.components.x_table.x_table.on_cell_sort(el,e);
});
var row_click_h_23350 = (function (e){
return app.components.x_table.x_table.on_row_click(el,e);
});
var row_conn_h_23351 = (function (e){
return app.components.x_table.x_table.on_row_connected(el,e);
});
el.addEventListener("x-table-cell-sort",sort_h_23349);

el.addEventListener("x-table-row-click",row_click_h_23350);

el.addEventListener("x-table-row-connected",row_conn_h_23351);

app.components.x_table.x_table.goog$module$goog$object.set(el,app.components.x_table.x_table.k_handlers,({"sort": sort_h_23349, "row-click": row_click_h_23350, "row-conn": row_conn_h_23351}));

return null;
});
app.components.x_table.x_table.remove_listeners_BANG_ = (function app$components$x_table$x_table$remove_listeners_BANG_(el){
var hs_23355 = app.components.x_table.x_table.goog$module$goog$object.get(el,app.components.x_table.x_table.k_handlers);
if(cljs.core.truth_(hs_23355)){
var sort_h_23357 = app.components.x_table.x_table.goog$module$goog$object.get(hs_23355,"sort");
var row_click_h_23358 = app.components.x_table.x_table.goog$module$goog$object.get(hs_23355,"row-click");
var row_conn_h_23359 = app.components.x_table.x_table.goog$module$goog$object.get(hs_23355,"row-conn");
if(cljs.core.truth_(sort_h_23357)){
el.removeEventListener("x-table-cell-sort",sort_h_23357);
} else {
}

if(cljs.core.truth_(row_click_h_23358)){
el.removeEventListener("x-table-row-click",row_click_h_23358);
} else {
}

if(cljs.core.truth_(row_conn_h_23359)){
el.removeEventListener("x-table-row-connected",row_conn_h_23359);
} else {
}
} else {
}
