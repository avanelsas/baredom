 ...
 */
app.components.x_table_cell.model.role_for_cell = (function app$components$x_table_cell$model$role_for_cell(p__23133){
var map__23135 = p__23133;
var map__23135__$1 = cljs.core.__destructure_map(map__23135);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23135__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23135__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
 ...
 */
app.components.x_table_cell.model.aria_sort_value = (function app$components$x_table_cell$model$aria_sort_value(p__23137){
...
var sort_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23138__$1,new cljs.core.Keyword(null,"sort-direction","sort-direction",-1635889628));
 ...
 */
app.components.x_table_cell.model.sort_btn_visible_QMARK_ = (function app$components$x_table_cell$model$sort_btn_visible_QMARK_(p__23141){
...
var sortable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23142__$1,new cljs.core.Keyword(null,"sortable?","sortable?",291547474));
 ...
 */
app.components.x_table_cell.model.sort_btn_tabindex = (function app$components$x_table_cell$model$sort_btn_tabindex(p__23147){
var map__23148 = p__23147;
var map__23148__$1 = cljs.core.__destructure_map(map__23148);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23148__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var sortable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23148__$1,new cljs.core.Keyword(null,"sortable?","sortable?",291547474));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23148__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
...
var G__23153 = current_direction;
switch (G__23153) {
case "none":
 ...
 */
app.components.x_table_cell.model.normalize = (function app$components$x_table_cell$model$normalize(p__23154){
var map__23155 = p__23154;
var map__23155__$1 = cljs.core.__destructure_map(map__23155);
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var col_span_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"col-span-raw","col-span-raw",1425293661));
var align_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"align-raw","align-raw",-723387357));
var row_span_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"row-span-raw","row-span-raw",-1130003707));
var valign_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"valign-raw","valign-raw",-1083375124));
var sort_direction_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"sort-direction-raw","sort-direction-raw",-1822100883));
var sortable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"sortable?","sortable?",291547474));
var truncate_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"truncate?","truncate?",135673334));
var type_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"type-raw","type-raw",-967209994));
var sticky_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"sticky-raw","sticky-raw",1857578519));
var scope_raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"scope-raw","scope-raw",-773628648));
 ...
 */
app.components.x_table_cell.model.connected_detail = (function app$components$x_table_cell$model$connected_detail(p__23165){
var map__23166 = p__23165;
var map__23166__$1 = cljs.core.__destructure_map(map__23166);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23166__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23166__$1,new cljs.core.Keyword(null,"scope","scope",-439358418));
var col_span = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23166__$1,new cljs.core.Keyword(null,"col-span","col-span",-232603210));
var row_span = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23166__$1,new cljs.core.Keyword(null,"row-span","row-span",-365554241));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23166__$1,new cljs.core.Keyword(null,"align","align",1964212802));
