...
(def form-controls
  {"x-checkbox"       {:value-type "boolean" :change-event "x-checkbox-change"       :change-request-event "x-checkbox-change-request"       :detail-field "checked" :write-mode :boolean-attr :attr-name "checked"}
   "x-switch"         {:value-type "boolean" :change-event "x-switch-change"         :change-request-event "x-switch-change-request"         :detail-field "checked" :write-mode :boolean-attr :attr-name "checked"}
   "x-radio"          {:value-type "boolean" :change-event "x-radio-change"          :change-request-event "x-radio-change-request"          :detail-field "checked" :write-mode :boolean-attr :attr-name "checked"}
