...
(def ^:private style-text
  (str
   ...
   "--x-dropdown-trigger-border:1px solid var(--x-color-border,#e2e8f0);"
   ...
   "--x-dropdown-panel-border:1px solid var(--x-color-border,#e2e8f0);"
   ...
   "--x-dropdown-trigger-bg-hover:var(--x-color-surface-active,#334155);"
   "--x-dropdown-trigger-bg-active:var(--x-color-surface-active,#475569);"
   "--x-dropdown-trigger-color:var(--x-color-text,#e2e8f0);"
   "--x-dropdown-trigger-border:1px solid var(--x-color-border,#334155);"
   "--x-dropdown-chevron-color:var(--x-color-text-muted,#94a3b8);"
   "--x-dropdown-focus-ring:var(--x-color-focus-ring,#93c5fd);"
   "--x-dropdown-panel-bg:var(--x-color-bg,#1e293b);"
   "--x-dropdown-panel-border:1px solid var(--x-color-border,#334155);"
   "--x-dropdown-panel-shadow:var(--x-shadow-md,0 4px 24px rgba(0,0,0,0.4));"
   "}"
   "}"
   "[part=trigger]{"
   "all:unset;"
