...
(def ^:private style-text
  (str
   ...
   "--x-popover-panel-bg:var(--x-color-surface,#ffffff);"
   ...
   "--x-popover-arrow-bg:var(--x-color-surface,#ffffff);"
   ...
   ":host{"
   "--x-popover-panel-bg:var(--x-color-surface,#1e293b);"
   ...
   "--x-popover-arrow-bg:var(--x-color-surface,#1e293b);"
