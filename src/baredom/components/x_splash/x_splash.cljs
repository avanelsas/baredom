...
(def style-text
  (str
   ...
   "--x-splash-bg:#ffffff;"
   "--x-splash-color:#0f172a;"
   "--x-splash-z-index:9999;"
   "--x-splash-fade-duration:400ms;"
   "--x-splash-fade-ease:cubic-bezier(0.4,0,0.2,1);"
   "--x-splash-spinner-size:40px;"
   "--x-splash-spinner-color:currentColor;"
   "--x-splash-spinner-track-color:rgba(0,0,0,0.12);"
   "--x-splash-spinner-thickness:3px;"
   "--x-splash-spinner-duration:0.75s;"
   "--x-splash-progress-height:4px;"
   "--x-splash-progress-color:#3b82f6;"
   "--x-splash-progress-track-color:rgba(0,0,0,0.08);"
   "--x-splash-progress-radius:2px;"
   "--x-splash-gap:20px;"
   ...
   ":host{"
   "--x-splash-bg:#0f172a;"
   "--x-splash-color:#f8fafc;"
   "--x-splash-spinner-track-color:rgba(255,255,255,0.15);"
   "--x-splash-progress-track-color:rgba(255,255,255,0.12);}}"
