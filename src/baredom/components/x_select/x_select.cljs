...
(def ^:private style-text
  (str
   ...
   "--x-select-bg:var(--x-color-surface,#ffffff);"
   "--x-select-bg-disabled:var(--x-color-surface-hover,#f8fafc);"
   ...
   ":host{"
   "--x-select-bg:var(--x-color-surface,#1f2937);"
   "--x-select-bg-disabled:var(--x-color-surface,#111827);"
