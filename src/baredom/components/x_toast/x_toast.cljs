...
(def style-text
  (str
   ...
   "--x-toast-info-bg:var(--x-color-surface,#ffffff);"
   ...
   "--x-toast-success-bg:var(--x-color-surface,#ffffff);"
   ...
   "--x-toast-warning-bg:var(--x-color-surface,#ffffff);"
   ...
   "--x-toast-error-bg:var(--x-color-surface,#ffffff);"
   ...
   "--x-toast-info-bg:var(--x-color-surface,#1e293b);"
   ...
   "--x-toast-success-bg:var(--x-color-surface,#1e293b);"
   ...
   "--x-toast-warning-bg:var(--x-color-surface,#1e293b);"
   ...
   "--x-toast-error-bg:var(--x-color-surface,#1e293b);"
