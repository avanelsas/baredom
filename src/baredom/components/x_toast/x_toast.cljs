...
(def style-text
  (str
   ...
   "--x-toast-focus-ring:var(--x-color-focus-ring,rgba(0,0,0,0.6));"
   "--x-toast-dismiss-color:var(--x-color-text-muted,rgba(0,0,0,0.50));"
   "--x-toast-dismiss-hover-bg:var(--x-color-surface-hover,rgba(0,0,0,0.06));"
   "--x-toast-progress-height:3px;"
   "--x-toast-progress-bg:var(--x-color-border,rgba(0,0,0,0.08));"
   ...
   ":host{"
   "--x-toast-shadow:var(--x-shadow-md,0 4px 20px rgba(0,0,0,0.40),0 1px 6px rgba(0,0,0,0.30));"
   "--x-toast-focus-ring:var(--x-color-focus-ring,rgba(255,255,255,0.75));"
   "--x-toast-dismiss-color:var(--x-color-text-muted,rgba(255,255,255,0.65));"
   "--x-toast-dismiss-hover-bg:var(--x-color-surface-hover,rgba(255,255,255,0.12));"
   "--x-toast-progress-bg:var(--x-color-border,rgba(255,255,255,0.10));"
...
(defn init! []
  (component/register! model/tag-name
    {:observed-attributes    model/observed-attributes
     ...
     :setup-prototype-fn     (fn [proto] (install-property-accessors! proto) (install-dismiss-method! proto))}))
