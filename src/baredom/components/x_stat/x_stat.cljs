...
(def css-text
  (str
   ...
   "--x-stat-color:inherit;"
   "--x-stat-muted-color:rgba(0,0,0,0.55);"
   "--x-stat-border-color:transparent;"
   "--x-stat-radius:12px;"
   "--x-stat-padding:16px;"
   "--x-stat-gap:6px;"
   ...
   "--x-stat-positive-color:#16a34a;"
   "--x-stat-warning-color:#d97706;"
   "--x-stat-danger-color:#dc2626;"
   "--x-stat-transition-duration:120ms;"
   "--x-stat-transition-timing:ease;"
   "--x-stat-loading-opacity:0.6;}"

   "@media (prefers-color-scheme:dark){"
   ":host{"
   "--x-stat-muted-color:rgba(255,255,255,0.55);"
   "--x-stat-positive-color:#4ade80;"
   "--x-stat-warning-color:#fbbf24;"
   "--x-stat-danger-color:#f87171;}}"
