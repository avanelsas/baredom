...
(def style-text
  ...
  (let [sans  "system-ui,-apple-system,sans-serif"
    ...
    (str
     ...
     "color:var(--x-typography-color,inherit);}"
     ...
     "border-left:3px solid var(--x-typography-blockquote-border-color," bq-bd-light ");"
     "padding:var(--x-typography-blockquote-padding,0 0 0 1em);}"
     "@media (prefers-color-scheme:dark){"
     ":host([data-variant='blockquote']) [part=container]{"
     "border-left-color:var(--x-typography-blockquote-border-color," bq-bd-dark ");}}"
     ...
     "background:var(--x-typography-code-bg," code-bg-light ");"
     "border-radius:var(--x-typography-code-radius,4px);"
     "padding:var(--x-typography-code-padding,0.15em 0.35em);}"
     "@media (prefers-color-scheme:dark){"
     ":host([data-variant='code']) [part=container]{"
     "background:var(--x-typography-code-bg," code-bg-dark ");}}"
     ...
     "background:var(--x-typography-kbd-bg," kbd-bg-light ");"
     "border:1px solid var(--x-typography-kbd-border," kbd-bd-light ");"
     "border-radius:var(--x-typography-kbd-radius,4px);"
     "padding:var(--x-typography-kbd-padding,0.15em 0.4em);}"
     "@media (prefers-color-scheme:dark){"
     ":host([data-variant='kbd']) [part=container]{"
     "background:var(--x-typography-kbd-bg," kbd-bg-dark ");"
     "border-color:var(--x-typography-kbd-border," kbd-bd-dark ");}}"
