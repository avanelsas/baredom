...
(def ^:private style-text
  (str
   ...
   ":host(:not([orientation=vertical])) [part='start']{order:2;margin-inline-end:auto;}"
   ":host(:not([orientation=vertical])) [part='nav']{"
   "order:4;flex-basis:100%;flex-wrap:wrap;}"
   ":host(:not([orientation=vertical])) [part='actions']{"
   "order:5;flex-basis:100%;flex-wrap:wrap;}"
   ":host(:not([orientation=vertical])) [part='toggle']{order:6;}"
   ":host(:not([orientation=vertical])) [part='end']{"
   "order:7;margin-inline-start:auto;}"
   "}"
