...
(def ^:private style-text
  (str
   ...
   ":host(:not([orientation=vertical])) [part='start']{order:2;}"
   ":host(:not([orientation=vertical])) [part='toggle']{order:3;justify-self:end;}"
   ":host(:not([orientation=vertical])) [part='nav']{"
   "order:5;grid-column:1/-1;flex-wrap:wrap;}"
   ":host(:not([orientation=vertical])) [part='actions']{"
   "order:6;grid-column:1/-1;justify-self:start;flex-wrap:wrap;}"
