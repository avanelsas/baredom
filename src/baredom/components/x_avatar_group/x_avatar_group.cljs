...
(def style-text
  (str
   ...
   "--x-avatar-group-overflow-bg:var(--x-color-surface, rgba(0,0,0,0.08));"
   "--x-avatar-group-overflow-color:var(--x-color-text-muted, rgba(0,0,0,0.70));"
   ...
   ":host{"
   "--x-avatar-group-overflow-bg:var(--x-color-surface, rgba(255,255,255,0.10));"
   "--x-avatar-group-overflow-color:var(--x-color-text-muted, rgba(255,255,255,0.75));"
   "--x-avatar-group-overflow-border:var(--x-color-border, rgba(255,255,255,0.18));"
   "--x-avatar-group-overflow-ring:var(--x-color-bg, #0b0c0f);}}"
