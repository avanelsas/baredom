...
(def style-text
  (str
   ...
   "--x-scroll-control-bg:rgba(255,255,255,0.9);"
   "--x-scroll-control-color:rgba(0,0,0,0.7);"
   "--x-scroll-control-hover-bg:rgba(255,255,255,1);"
   "--x-scroll-control-border-radius:50%;"
   "--x-scroll-control-shadow:0 2px 8px rgba(0,0,0,.15);"
   "--x-scroll-indicator-size:8px;"
   "--x-scroll-indicator-gap:6px;"
   "--x-scroll-indicator-color:rgba(0,0,0,0.25);"
   "--x-scroll-indicator-active-color:rgba(0,0,0,0.7);"
   "--x-scroll-transition-duration:300ms;"
   "--x-scroll-slide-size:100%;"
   "--x-scroll-disabled-opacity:0.55;"
   "--x-scroll-focus-ring:rgba(0,102,204,0.6);}"

   "@media (prefers-color-scheme:dark){:host{"
   "--x-scroll-control-bg:rgba(40,40,40,0.9);"
   "--x-scroll-control-color:rgba(255,255,255,0.8);"
   "--x-scroll-control-hover-bg:rgba(50,50,50,1);"
   "--x-scroll-control-shadow:0 2px 8px rgba(0,0,0,.4);"
   "--x-scroll-indicator-color:rgba(255,255,255,0.3);"
   "--x-scroll-indicator-active-color:rgba(255,255,255,0.8);"
   "--x-scroll-focus-ring:rgba(100,180,255,0.7);}}"
...
(defn- add-listeners! [^js el]
  (let [{:keys [prev-btn next-btn slot viewport]} (ensure-refs! el)
    ...
    (.addEventListener el "mouseenter" enter-h)
    (.addEventListener el "mouseleave" leave-h)
  ...
  (let [hs   (gobj/get el k-handlers)
    ...
    (when (and hs refs)
      (let [^js prev-btn (:prev-btn refs)
        ...
        (when-let [h (gobj/get hs "enter")]   (.removeEventListener el "mouseenter" h))
        (when-let [h (gobj/get hs "leave")]   (.removeEventListener el "mouseleave" h))
