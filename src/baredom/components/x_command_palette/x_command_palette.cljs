...
(def ^:private style-text
  (str
   ...
   "background:var(--x-command-palette-bg,var(--x-color-surface,#fff));"
   ...
   "[part=panel]{background:var(--x-command-palette-bg,var(--x-color-surface,#1e293b));box-shadow:0 20px 60px rgba(0,0,0,0.6),0 4px 16px rgba(0,0,0,0.4);}"
