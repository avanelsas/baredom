(ns app.components.x-toast.x-toast
  (:require
   [goog.object :as gobj]
...
(def style-text
  (str
   ...
   "--x-toast-min-width:280px;"
   "--x-toast-max-width:480px;"
   "--x-toast-border-width:1px;"
   "--x-toast-shadow:0 4px 16px rgba(0,0,0,0.12),0 1px 4px rgba(0,0,0,0.08);"
   "--x-toast-motion-fast:120ms;"
   "--x-toast-motion-ease:cubic-bezier(0.2,0,0,1);"
