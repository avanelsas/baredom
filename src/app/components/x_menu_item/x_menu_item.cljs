(ns app.components.x-menu-item.x-menu-item
  (:require
   [goog.object :as gobj]
...
(def style-text
  (str
   ...
   "--x-menu-item-color:#111827;"
   "--x-menu-item-hover-bg:#f3f4f6;"
   "--x-menu-item-focus-bg:#eff6ff;"
   "--x-menu-item-focus-color:#1d4ed8;"
   "--x-menu-item-disabled-opacity:0.45;"
   "--x-menu-item-danger-color:#dc2626;"
   "--x-menu-item-danger-hover-bg:#fef2f2;"
   "--x-menu-item-padding:8px 12px;"
   "--x-menu-item-border-radius:4px;"
   "--x-menu-item-font-size:0.9375rem;"
   "--x-menu-item-icon-gap:8px;"
   "--x-menu-item-divider-color:#e5e7eb;}"
   "@media (prefers-color-scheme:dark){"
   ":host{"
   "--x-menu-item-color:#f9fafb;"
   "--x-menu-item-hover-bg:#1f2937;"
   "--x-menu-item-focus-bg:#1e3a5f;"
   "--x-menu-item-focus-color:#60a5fa;"
   "--x-menu-item-danger-color:#f87171;"
   "--x-menu-item-danger-hover-bg:#2d1515;"
   "--x-menu-item-divider-color:#374151;}}"
   ".base{"
