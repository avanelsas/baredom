(ns app.components.x-copy.x-copy
  (:require
   [goog.object :as gobj]
   [app.components.x-copy.model :as model]))
...
(def style-text
  (str
   ...
   "--x-copy-tooltip-bg:#1e293b;"
   "--x-copy-tooltip-fg:#f8fafc;"
   "--x-copy-tooltip-success-bg:#15803d;"
   "--x-copy-tooltip-success-fg:#f0fdf4;"
   "--x-copy-tooltip-error-bg:#b91c1c;"
   "--x-copy-tooltip-error-fg:#fef2f2;"
   "--x-copy-tooltip-radius:6px;"
   "--x-copy-tooltip-padding:4px 8px;"
   "--x-copy-tooltip-font-size:0.8125rem;"
   "--x-copy-tooltip-z:100;"
   "}"
   "@media (prefers-color-scheme:dark){"
   ":host{"
   "--x-copy-tooltip-bg:#0f172a;"
   "--x-copy-tooltip-fg:#e2e8f0;"
   "--x-copy-tooltip-success-bg:#166534;"
   "--x-copy-tooltip-success-fg:#dcfce7;"
   "--x-copy-tooltip-error-bg:#991b1b;"
