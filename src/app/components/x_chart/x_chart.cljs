(ns app.components.x-chart.x-chart
...
(def ^:private style-text
  (str
   ...
   "--x-chart-border:rgba(0,0,0,0.1);"
   "--x-chart-grid:rgba(0,0,0,0.08);"
   "--x-chart-axis-label:rgba(0,0,0,0.5);"
   "--x-chart-skeleton:linear-gradient(90deg,rgba(0,0,0,0.06) 25%,rgba(0,0,0,0.03) 50%,rgba(0,0,0,0.06) 75%);"
   "--x-chart-tooltip-bg:rgba(255,255,255,0.96);"
   "--x-chart-tooltip-border:rgba(0,0,0,0.12);"
   "--x-chart-tooltip-shadow:0 4px 16px rgba(0,0,0,0.14);"
   "--x-chart-focus-ring:rgba(0,102,204,0.55);"
   "--x-chart-radius:0.75rem;"
   "--x-chart-tooltip-radius:0.5rem;"
   "--x-chart-tooltip-padding:0.45rem 0.7rem;"
   "--x-chart-tooltip-font-size:0.8125rem;"
   "--x-chart-tooltip-header-color:rgba(0,0,0,0.5);"
   "--x-chart-tooltip-label-color:rgba(0,0,0,0.65);"
   "--x-chart-tooltip-value-color:rgba(0,0,0,0.9);"
   "--x-chart-tooltip-swatch-size:8px;"
   "--x-chart-tooltip-gap:0.35rem;"
   "--x-chart-crosshair-color:rgba(0,0,0,0.18);"
   ...
   "--x-chart-border:rgba(255,255,255,0.1);"
   "--x-chart-grid:rgba(255,255,255,0.08);"
   "--x-chart-axis-label:rgba(255,255,255,0.45);"
   "--x-chart-skeleton:linear-gradient(90deg,rgba(255,255,255,0.06) 25%,rgba(255,255,255,0.03) 50%,rgba(255,255,255,0.06) 75%);"
   "--x-chart-tooltip-bg:rgba(30,30,35,0.97);"
   "--x-chart-tooltip-border:rgba(255,255,255,0.12);"
   "--x-chart-tooltip-shadow:0 4px 20px rgba(0,0,0,0.45);"
   "--x-chart-focus-ring:rgba(120,190,255,0.55);"
   "--x-chart-tooltip-header-color:rgba(255,255,255,0.45);"
   "--x-chart-tooltip-label-color:rgba(255,255,255,0.6);"
   "--x-chart-tooltip-value-color:rgba(255,255,255,0.9);"
   "--x-chart-crosshair-color:rgba(255,255,255,0.2);"
   "}"
   "}"
   "[part=container]{"
   "position:relative;"
...
(defn- data-pt-x [pt i kind x-dom x0 x1]
  (if (= kind "category")
    (scale-x-category i (- (second x-dom) (first x-dom)) x0 x1)
