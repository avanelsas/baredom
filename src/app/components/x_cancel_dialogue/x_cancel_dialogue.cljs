(ns app.components.x-cancel-dialogue.x-cancel-dialogue
  (:require
   [goog.object :as gobj]
...
(def style-text
  (str
   ...
   "--x-cancel-dialogue-bg:#ffffff;"
   "--x-cancel-dialogue-fg:#0f172a;"
   "--x-cancel-dialogue-radius:12px;"
   "--x-cancel-dialogue-shadow:0 20px 60px rgba(0,0,0,0.20),0 4px 12px rgba(0,0,0,0.10);"
   "--x-cancel-dialogue-padding:24px;"
   "--x-cancel-dialogue-min-width:320px;"
   "--x-cancel-dialogue-max-width:480px;"
   "--x-cancel-dialogue-headline-size:1.125rem;"
   "--x-cancel-dialogue-headline-weight:700;"
   "--x-cancel-dialogue-message-size:0.9375rem;"
   "--x-cancel-dialogue-cancel-bg:#f1f5f9;"
   "--x-cancel-dialogue-cancel-fg:#0f172a;"
   "--x-cancel-dialogue-cancel-bg-hover:#e2e8f0;"
   "--x-cancel-dialogue-confirm-bg:#2563eb;"
   "--x-cancel-dialogue-confirm-fg:#ffffff;"
   "--x-cancel-dialogue-confirm-bg-hover:#1d4ed8;"
   "--x-cancel-dialogue-danger-bg:#dc2626;"
   "--x-cancel-dialogue-danger-fg:#ffffff;"
   "--x-cancel-dialogue-danger-bg-hover:#b91c1c;"
   "--x-cancel-dialogue-btn-radius:8px;"
   "--x-cancel-dialogue-btn-height:2.5rem;"
   "--x-cancel-dialogue-btn-font-size:0.9375rem;"
   "--x-cancel-dialogue-btn-font-weight:600;"
   "--x-cancel-dialogue-focus-ring:#60a5fa;"
   "--x-cancel-dialogue-enter-duration:0ms;"
   "--x-cancel-dialogue-exit-duration:0ms;"
   "}"
   "@media (prefers-color-scheme:dark){"
   ":host{"
   "--x-cancel-dialogue-bg:#1e293b;"
   "--x-cancel-dialogue-fg:#f1f5f9;"
   ...
   "--x-cancel-dialogue-cancel-bg:#334155;"
   "--x-cancel-dialogue-cancel-fg:#f1f5f9;"
   "--x-cancel-dialogue-cancel-bg-hover:#475569;"
   "--x-cancel-dialogue-confirm-bg:#3b82f6;"
   "--x-cancel-dialogue-confirm-bg-hover:#2563eb;"
   "--x-cancel-dialogue-focus-ring:#93c5fd;"
   "}}"
   "[part=backdrop]{"
   "display:none;"
   "position:fixed;"
...
(defn- read-model [^js el]
  (model/normalize
   {:open-present?     (.hasAttribute el model/attr-open)
    ...
    :portal-raw        (.getAttribute el model/attr-portal)}))
