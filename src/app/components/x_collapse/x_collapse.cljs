(ns app.components.x-collapse.x-collapse
...
(def ^:private style-text
  (str
   ...
   "--x-collapse-border-radius:8px;"
   "--x-collapse-border:1px solid #e2e8f0;"
   "--x-collapse-bg:#ffffff;"
   "--x-collapse-trigger-bg:#f8fafc;"
   "--x-collapse-trigger-bg-hover:#f1f5f9;"
   "--x-collapse-trigger-color:#0f172a;"
   ...
   "--x-collapse-chevron-color:#64748b;"
   "--x-collapse-focus-ring:#60a5fa;"
   "--x-collapse-transition-easing:ease;"
   "}"
   "@media (prefers-color-scheme:dark){"
   ":host{"
   "--x-collapse-border:1px solid #334155;"
   "--x-collapse-bg:#1e293b;"
   "--x-collapse-trigger-bg:#0f172a;"
   "--x-collapse-trigger-bg-hover:#1e293b;"
   "--x-collapse-trigger-color:#e2e8f0;"
   "--x-collapse-chevron-color:#94a3b8;"
   "--x-collapse-focus-ring:#93c5fd;"
   "}"
   "}"
   "[part=container]{"
...
(defn- render! [^js el]
  (when-let [refs (gobj/get el k-refs)]
    (let [^js trigger-el     (gobj/get refs "trigger")
      ...
      (if disabled?
        (set-attr! trigger-el "disabled" "")
        (remove-attr! trigger-el "disabled")))))
