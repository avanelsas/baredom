(ns app.components.x-button.x-button
...
(defn style-text
  ...
  (str
   ...
   "--x-button-shadow:0 1px 2px rgba(15,23,42,0.08),0 1px 1px rgba(15,23,42,0.04);"
   "--x-button-shadow-hover:0 4px 10px rgba(15,23,42,0.10),0 2px 4px rgba(15,23,42,0.06);"
   "--x-button-shadow-active:0 1px 2px rgba(15,23,42,0.08);"
   "--x-button-bg:#2563eb;"
   ...
   "--x-button-secondary-bg:#ffffff;"
   "--x-button-secondary-bg-hover:#f8fafc;"
   "--x-button-secondary-bg-active:#f1f5f9;"
   "--x-button-secondary-fg:#0f172a;"
   "--x-button-secondary-border:#cbd5e1;"
   "--x-button-tertiary-bg:#f1f5f9;"
   "--x-button-tertiary-bg-hover:#e2e8f0;"
   "--x-button-tertiary-bg-active:#cbd5e1;"
   "--x-button-tertiary-fg:#0f172a;"
   "--x-button-ghost-bg:transparent;"
   "--x-button-ghost-bg-hover:#f8fafc;"
   "--x-button-ghost-bg-active:#f1f5f9;"
   "--x-button-ghost-fg:#334155;"
   "--x-button-danger-bg:#dc2626;"
   "--x-button-danger-bg-hover:#b91c1c;"
   "--x-button-danger-bg-active:#991b1b;"
   "--x-button-danger-fg:#ffffff;"
   "--x-button-focus-ring:#60a5fa;"
   "--x-button-transition-duration:140ms;"
   "--x-button-transition-easing:cubic-bezier(0.2,0,0,1);"
   "}"
   "@media (prefers-color-scheme: dark){"
   ":host{"
   "--x-button-shadow:0 1px 2px rgba(0,0,0,0.35),0 1px 1px rgba(0,0,0,0.2);"
   "--x-button-shadow-hover:0 6px 14px rgba(0,0,0,0.35),0 2px 6px rgba(0,0,0,0.24);"
   "--x-button-shadow-active:0 1px 2px rgba(0,0,0,0.3);"
   "--x-button-bg:#3b82f6;"
   "--x-button-bg-hover:#2563eb;"
   "--x-button-bg-active:#1d4ed8;"
   "--x-button-bg-disabled:#334155;"
   "--x-button-fg:#eff6ff;"
   "--x-button-fg-disabled:#94a3b8;"
   "--x-button-secondary-bg:#111827;"
   "--x-button-secondary-bg-hover:#1f2937;"
   "--x-button-secondary-bg-active:#273449;"
   "--x-button-secondary-fg:#e5e7eb;"
   "--x-button-secondary-border:#374151;"
   "--x-button-tertiary-bg:#1e293b;"
   "--x-button-tertiary-bg-hover:#273449;"
   "--x-button-tertiary-bg-active:#334155;"
   "--x-button-tertiary-fg:#e5e7eb;"
   "--x-button-ghost-bg:transparent;"
   "--x-button-ghost-bg-hover:#0f172a;"
   "--x-button-ghost-bg-active:#172033;"
   "--x-button-ghost-fg:#cbd5e1;"
   "--x-button-danger-bg:#ef4444;"
