(ns app.components.x-drawer.x-drawer
  (:require
   [goog.object :as gobj]
...
(def ^:private style-text
  (str
   ...
   "--x-drawer-size:20rem;"
   "--x-drawer-bg:Canvas;"
   "--x-drawer-fg:CanvasText;"
   "--x-drawer-backdrop:rgb(0 0 0/0.4);"
   "--x-drawer-shadow:0 8px 24px rgb(0 0 0/0.18);"
   "--x-drawer-duration:200ms;"
   ...
   "--x-drawer-border:color-mix(in srgb,currentColor 12%,transparent);"
   "}"
   "[part=backdrop]{"
   "display:none;"
   "position:fixed;"
