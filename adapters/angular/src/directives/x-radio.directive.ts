// x-radio.directive.ts — auto-generated by generate_angular.bb, do not edit
...
@Directive({ selector: 'x-radio', standalone: true })
export class BaredomRadio implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.listen('x-radio-change-request', this.changeRequest);
    this.listen('x-radio-change', this.change);
  }
