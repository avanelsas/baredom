// x-progress.directive.ts — auto-generated by generate_angular.bb, do not edit
...
@Directive({ selector: 'x-progress', standalone: true })
export class BaredomProgress implements OnInit, OnDestroy {
  private el: XProgressElement;
  private zone: NgZone;
  private listeners: Array<() => void> = [];

  constructor(elRef: ElementRef<XProgressElement>, zone: NgZone) {
  ...
  ngOnInit(): void {
    this.listen('x-progress-complete', this.complete);
  }
