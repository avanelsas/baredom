(ns app.components.x-progress-circle.x-progress-circle-test
  (:require [cljs.test :refer-macros [deftest is testing use-fixtures]]
            [app.components.x-progress-circle.x-progress-circle :as x-progress-circle]
            [app.components.x-progress-circle.model :as model]))
