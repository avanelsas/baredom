(ns app.components.x-file-download.x-file-download-test
  (:require [cljs.test :refer-macros [deftest is testing use-fixtures]]
            [app.components.x-file-download.x-file-download :as x]
            [app.components.x-file-download.model :as model]))
