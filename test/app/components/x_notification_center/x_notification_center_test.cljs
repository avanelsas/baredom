(ns app.components.x-notification-center.x-notification-center-test
  (:require [cljs.test :refer-macros [deftest is testing use-fixtures async]]
            [app.components.x-alert.x-alert :as xa]
            [app.components.x-notification-center.x-notification-center :as nc]
