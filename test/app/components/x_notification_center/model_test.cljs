(ns app.components.x-notification-center.model-test
...
;; ── bottom-position? ──────────────────────────────────────────────────────────
(deftest bottom-position-true-test
  (is (true? (model/bottom-position? "bottom-right")))
  (is (true? (model/bottom-position? "bottom-left")))
  (is (true? (model/bottom-position? "bottom-center"))))

(deftest bottom-position-false-test
  (is (false? (model/bottom-position? "top-right")))
  (is (false? (model/bottom-position? "top-left")))
  (is (false? (model/bottom-position? "top-center")))
  (is (false? (model/bottom-position? nil)))
  (is (false? (model/bottom-position? ""))))
