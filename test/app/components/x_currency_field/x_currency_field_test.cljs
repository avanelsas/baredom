(ns app.components.x-currency-field.x-currency-field-test
  (:require [cljs.test :refer-macros [deftest is testing use-fixtures async]]
            [app.components.x-currency-field.x-currency-field :as x]
            [app.components.x-currency-field.model :as model]))
