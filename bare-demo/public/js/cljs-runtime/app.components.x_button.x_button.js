...
var temp__5821__auto___21182 = app.components.x_button.model.aria_busy(public_state);
if(cljs.core.truth_(temp__5821__auto___21182)){
var v_21189 = temp__5821__auto___21182;
button_el.setAttribute("aria-busy",v_21189);
} else {
...
var state_21256 = app.components.x_button.x_button.create_shadow_BANG_(el);
var button_el_21257 = (state_21256["button"]);
app.components.x_button.x_button.set_hover_BANG_(el,false);
...
app.components.x_button.x_button.setup_hover_BANG_(el,button_el_21257);

app.components.x_button.x_button.setup_press_BANG_(el,button_el_21257);

app.components.x_button.x_button.setup_focus_BANG_(el,button_el_21257);

app.components.x_button.x_button.setup_slots_BANG_(el,state_21256);

app.components.x_button.x_button.set_el_state_BANG_(el,state_21256);
}
