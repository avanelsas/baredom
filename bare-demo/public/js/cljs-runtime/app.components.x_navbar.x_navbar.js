...
var state_20772 = app.components.x_navbar.x_navbar.create_shadow_BANG_(el);
var base_el_20773 = (state_20772["base"]);
app.components.x_navbar.x_navbar.set_focus_visible_BANG_(el,false);

app.components.x_navbar.x_navbar.setup_delegated_events_BANG_(el,base_el_20773);

app.components.x_navbar.x_navbar.setup_slots_BANG_(el,state_20772);

app.components.x_navbar.x_navbar.set_el_state_BANG_(el,state_20772);
}
