...
var i_14315 = (self__.level + (1));
while(true){
if((i_14315 <= (new_level + (1)))){
(update[i_14315] = self__.header);

var G__14316 = (i_14315 + (1));
i_14315 = G__14316;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14318 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14318[i]));
} else {
x__$2.forward.push((((i < links_14318.length))?(links_14318[i]):null));
}

if((i < links_14318.length)){
(links_14318[i] = x__$2);
} else {
links_14318.push(x__$2);
}
...
var i_14322 = (0);
while(true){
if((i_14322 <= self__.level)){
var links_14323 = (update[i_14322]).forward;
if((x__$1 === (((i_14322 < links_14323.length))?(links_14323[i_14322]):null))){
(links_14323[i_14322] = (x__$1.forward[i_14322]));

var G__14324 = (i_14322 + (1));
i_14322 = G__14324;
continue;
} else {
var G__14325 = (i_14322 + (1));
i_14322 = G__14325;
continue;
}
} else {
...
var G__14328 = nx;
var G__14329 = (level__$1 - (1));
x = G__14328;
level__$1 = G__14329;
continue;
} else {
var G__14330 = x;
var G__14331 = (level__$1 - (1));
x = G__14330;
level__$1 = G__14331;
continue;
}
